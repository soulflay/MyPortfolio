  ...
  return (
    ...
    >
      ...
      >
        {items.map((item, idx) => (
          <li
            className="relative w-[350px] max-w-full shrink-0 rounded-2xl border border-b-0 border-zinc-200 bg-[linear-gradient(180deg,#fafafa,#f5f5f5)] p-5 md:p-10 md:w-[60vw] dark:border-zinc-800"
            style={{
              background: '#090921',
          ...
          >
            <blockquote>
              ...
              ></div>
              <span className="relative z-20 text-[15px] md:text-[16px] leading-[1.6] font-normal text-neutral-800 dark:text-white">
                {item.quote}
              </span>
